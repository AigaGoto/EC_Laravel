                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.login') }}">
                        ...
                        <div class="form-group row">
                            <label for="admin_email" class="col-md-4 col-form-label text-md-right">{{ __('メールアドレス') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="admin_password" class="col-md-4 col-form-label text-md-right">{{ __('パスワード') }}</label>
